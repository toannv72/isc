...
export default function Home() {
    ...
    return (
        <>
            ...
            <ComProducts link={`/product?limit=9`} text={textApp.Home.text} getAll={'/showAll'}/>
            <ComProducts link={`/product/sold?limit=9`} text={'Sản phẩm bán chạy nhất'} getAll={'/showAllSold'}/>
            <ComFooter />
        </>
    )
}