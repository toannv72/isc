...
import "./ComAllSold.css";
import { InputNumber, Pagination, Select } from "antd";
import ComHeader from "../ComHeader/ComHeader";

export default function ComAllProductsSold({ text, link, getAll }) {
      ...
      <div className="bg-white p-4">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-4 lg:max-w-7xl lg:px-8">
          ...
          <div className="flex justify-end p-4">
            <Pagination current={page} total={products.totalDocs} showSizeChanger={false} defaultPageSize={9} onChange={onChange} />
          </div>
        </div>
      </div>
    </>
